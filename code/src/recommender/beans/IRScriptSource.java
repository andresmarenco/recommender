...
public class IRScriptSource implements Serializable {
	 ...
	 * @param IFW SCript Source IFW
	 */
	public IRScriptSource(long id, String name, double IFW) {
		super();
		this.id = id;
		this.name = name;
		this.IFW = IFW;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IRScriptSource other = (IRScriptSource) obj;
		if (id != other.id)
			return false;
		return true;
	}
